...
\setbeamertemplate{footline}{%
  ...
  \tikz[remember picture, overlay,xscale=0.875,transform shape]{
    ...
    \node[anchor=south west] at (current page.south west) {Sungho Shin--- \href{mailto:sushin@mit.edu}{sushin@mit.edu}};
...
\begin{frame}{Linear algebra within IPM (on CPUs)}
  ...
  \item<3-> ${\color{red}Q}$: Pivoting (computed on-the-fly during factorization) \visible<7>{\alert{$\longleftarrow$ this is the pain point}}
