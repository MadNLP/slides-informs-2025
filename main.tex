...
\begin{frame}{Linear algebra within IPM (on CPUs)}
  \begin{block}{LBL$^\top$ factorization \citep{duffMultifrontalSolutionIndefinite1983}}
    \vspace{-1em}
    \begin{align*}
      \begin{bmatrix}
...
\begin{frame}{Pivoting-free IPM}{\cite{montoisonGPUImplementationSecondOrder2025}}
  ...
  \item<3-> When pivoting is not required, \alert{GPU sparse direct solvers can be very efficient}
